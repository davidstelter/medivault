var localFile2 = {
  ...
  create : function(isDir, name) {
    var dir = this.init(localTree2.constructPath(gRemotePath.value, name));
  ...
  showProperties : function(file, recursive) {
    try {
      ...
      if (file.isDirectory() && recursive) {
        localTree2.getRecursiveFolderData(file, recursiveFolderData);
      }
      ...
      var params = { path                : file.path,
                     ...
                     date                : date,
                     origPermissions     : gSlash == "/" ? "-" + localTree2.convertPermissions(false, file.permissions) : 0,
                     permissions         : "",
